...
constinit const GlobalImageMetadata GLOBAL_IMAGE_METADATA
    __attribute__((used, section(".metadata_table"))) { .images {
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[0] },
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[1] },
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[2] },
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[3] },
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[4] },
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[5] },
        { .imageBegin = PlatformParameters::IMAGE_BEGIN_ADDRESSES[6] } } };
