...
void MetadataInterface::init()
{
    ...
    for (size_t i = 0; i < NUMBER_OF_IMAGES; i++) {
        updateImageBegin(reinterpret_cast<Image*>(IMAGE_BEGIN_ADDRESSES[i]), i); // NOLINT
    }
    // TODO
...
int32_t MetadataInterface::updateGlobalBootcounter(int32_t bootcounter)
{
    // Update SPI
...
Image* MetadataInterface::updateImageBegin(Image* imageBegin, size_t imageIndex)
{
    if (imageIndex >= NUMBER_OF_IMAGES) {
        return nullptr;
    }
