...
constexpr PinMapCollection<3> UART_PIN_MAPS { UART0_PIN_MAP, UART1_PIN_MAP, UART2_PIN_MAP };
...
constexpr NssPinMap<23> SPI1_NSS_MAP { {
    { P<'B', 0>, { FUN3, SS7 } },  { P<'B', 1>, { FUN3, SS6 } },  { P<'B', 2>, { FUN3, SS5 } },
    { P<'B', 3>, { FUN3, SS4 } },  { P<'B', 4>, { FUN3, SS3 } },  { P<'B', 5>, { FUN3, SS2 } },
    { P<'B', 6>, { FUN3, SS1 } },  { P<'B', 7>, { FUN3, SS0 } },

    { P<'C', 7>, { FUN2, SS1 } },  { P<'C', 8>, { FUN2, SS0 } },

    { P<'E', 5>, { FUN3, SS7 } },  { P<'E', 6>, { FUN3, SS6 } },  { P<'E', 7>, { FUN3, SS5 } },
    { P<'E', 8>, { FUN2, SS4 } },  { P<'E', 9>, { FUN2, SS3 } },  { P<'E', 10>, { FUN2, SS2 } },
    { P<'E', 11>, { FUN2, SS1 } }, { P<'E', 12>, { FUN2, SS0 } },

    { P<'F', 2>, { FUN1, SS0 } },

    { P<'G', 2>, { FUN2, SS0 } },

    { P<'G', 4>, { FUN1, SS3 } },  { P<'G', 5>, { FUN1, SS2 } },  { P<'G', 6>, { FUN1, SS1 } },
} };
