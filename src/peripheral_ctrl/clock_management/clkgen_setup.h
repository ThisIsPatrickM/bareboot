...
public:
    ...
    constexpr XTAL_MODE getMode() const { return m_mode; }
...
public:
    ...
    constexpr PLL_SOURCE getSource() const { return m_source; }
    constexpr int32_t getFrequency() const { return m_frequency; }
...
public:
    ...
    constexpr SYSCLK_SOURCE getSource() const { return m_source; }
    constexpr int32_t getFrequency() const { return m_frequency; }
...
private:
    static constexpr int32_t determineFrequency(
        SYSCLK_SOURCE source, const XTALSetup& xtalSetup, const PLLSetup& pllSetup);
